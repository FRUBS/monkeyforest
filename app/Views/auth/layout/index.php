...
<head>
  ...
  <!-- Favicons -->
  <link href="<?= base_url() ?>/assets/login/img/favicon.png" rel="icon">
...
<body>
  ...
  <!-- Vendor JS Files -->
  <script src="<?= base_url() ?>/assets/login/vendor/apexcharts/apexcharts.min.js"></script>
  <script src="<?= base_url() ?>/assets/login/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="<?= base_url() ?>/assets/login/vendor/chart.js/chart.umd.js"></script>
  <script src="<?= base_url() ?>/assets/login/vendor/echarts/echarts.min.js"></script>
