    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide back-video" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="<?= base_url(''); ?>/assets/user/img/tanahgajah/tg1.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="<?= base_url(''); ?>/assets/user/img/tanahgajah/tg2.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="<?= base_url(''); ?>/assets/user/img/tanahgajah/tg3.jpg" class="d-block w-100" alt="...">
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-info align-center">
                        ...
                        <p>
                            Jl. Goa Gajah, Kemenuh<br>
                            Kabupaten Gianyar, Bali 80571<br><br>
                            <strong>Phone:</strong>(0361) 975685<br>
                ...
                <div class="col-lg-7 col-md-6 footer-newsletter">
                    <h4>Location</h4>
                    <iframe style="border:0; width: 100%; height: 270px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3945.7527352887005!2d115.2802578761193!3d-8.523370486341832!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd23d1aaaaaaaab%3A0x8a0b0591cd9e26b5!2sTanah%20Gajah%2C%20a%20Resort%20by%20Hadiprana%20-%20former%20The%20Chedi%20Club%20Ubud%2C%20Bali!5e0!3m2!1sen!2sid!4v1687946911886!5m2!1sen!2sid" frameborder="0" allowfullscreen></iframe>
