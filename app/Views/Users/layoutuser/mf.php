            ...
            <?php if (in_groups('admin')) : ?>
                <nav id="navbar" class="navbar">
                    <ul>
                        ...
                        <li><a class="nav-link scrollto" href="<?= base_url('/monkeyforest/gallery'); ?>">Gallery</a></li>
                        <li><a class="nav-link scrollto" href="<?php base_url('/monkeyforest/denah') ?>">Places</a></li>
                        <?php if (logged_in()) : ?>
